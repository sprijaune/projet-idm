...
public class SimplepdlValidator extends EObjectValidator {
	...
	protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
		switch (classifierID) {
			...
			case SimplepdlPackage.UTILISATION_RESSOURCE:
				return validateUtilisationRessource((UtilisationRessource)value, diagnostics, context);
	 ...
	 * @generated
	 */
	public boolean validateUtilisationRessource(UtilisationRessource utilisationRessource, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(utilisationRessource, diagnostics, context);
	}
