...
public class SimplepdlSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SimplepdlPackage.UTILISATION_RESSOURCE: {
				UtilisationRessource utilisationRessource = (UtilisationRessource)theEObject;
				T result = caseUtilisationRessource(utilisationRessource);
				if (result == null) result = caseProcessElement(utilisationRessource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Utilisation Ressource</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Utilisation Ressource</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseUtilisationRessource(UtilisationRessource object) {
		return null;
	}
