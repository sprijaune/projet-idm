...
public class SimplepdlFactoryImpl extends EFactoryImpl implements SimplepdlFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case SimplepdlPackage.UTILISATION_RESSOURCE: return createUtilisationRessource();
			default:
	 ...
	 */
	@Override
	public UtilisationRessource createUtilisationRessource() {
		UtilisationRessourceImpl utilisationRessource = new UtilisationRessourceImpl();
