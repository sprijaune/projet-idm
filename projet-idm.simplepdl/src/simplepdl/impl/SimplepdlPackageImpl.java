...
public class SimplepdlPackageImpl extends EPackageImpl implements SimplepdlPackage {
	 ...
	 * @generated
	 */
	private EClass utilisationRessourceEClass = null;
	 ...
	 */
	@Override
	public EAttribute getRessource_Quantite() {
	 ...
	 */
	@Override
	public EClass getUtilisationRessource() {
		return utilisationRessourceEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getUtilisationRessource_QuantiteUtilisee() {
		return (EAttribute)utilisationRessourceEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getUtilisationRessource_Ressource() {
		return (EReference)utilisationRessourceEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getUtilisationRessource_Workdefinition() {
		return (EReference)utilisationRessourceEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		utilisationRessourceEClass = createEClass(UTILISATION_RESSOURCE);
		createEAttribute(utilisationRessourceEClass, UTILISATION_RESSOURCE__QUANTITE_UTILISEE);
		createEReference(utilisationRessourceEClass, UTILISATION_RESSOURCE__RESSOURCE);
		createEReference(utilisationRessourceEClass, UTILISATION_RESSOURCE__WORKDEFINITION);
	...
	public void initializePackageContents() {
		...
		utilisationRessourceEClass.getESuperTypes().add(this.getProcessElement());
		...
		initEAttribute(getRessource_Type(), ecorePackage.getEString(), "type", null, 1, 1, Ressource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRessource_Quantite(), ecorePackage.getEInt(), "quantite", null, 1, 1, Ressource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(utilisationRessourceEClass, UtilisationRessource.class, "UtilisationRessource", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getUtilisationRessource_QuantiteUtilisee(), ecorePackage.getEInt(), "quantiteUtilisee", null, 1, 1, UtilisationRessource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUtilisationRessource_Ressource(), this.getRessource(), null, "ressource", null, 1, 1, UtilisationRessource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUtilisationRessource_Workdefinition(), this.getWorkDefinition(), null, "workdefinition", null, 1, 1, UtilisationRessource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (workSequenceEClass,
		   source,
		   new String[] {
			   "constraints", "previousWDinSameProcess nextWDinSameProcess"
		   });
	}
