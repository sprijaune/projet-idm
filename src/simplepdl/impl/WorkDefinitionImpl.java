 ...
 *   <li>{@link simplepdl.impl.WorkDefinitionImpl#getRessources <em>Ressources</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition {
	...
	public EList<Ressource> getRessources() {
		if (ressources == null) {
			ressources = new EObjectResolvingEList<Ressource>(Ressource.class, this, SimplepdlPackage.WORK_DEFINITION__RESSOURCES);
		}
		return ressources;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__NAME:
				return getName();
			case SimplepdlPackage.WORK_DEFINITION__RESSOURCES:
