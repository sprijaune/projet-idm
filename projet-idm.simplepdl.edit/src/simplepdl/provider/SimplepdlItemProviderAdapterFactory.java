...
public class SimplepdlItemProviderAdapterFactory extends SimplepdlAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link simplepdl.UtilisationRessource} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected UtilisationRessourceItemProvider utilisationRessourceItemProvider;

	/**
	 * This creates an adapter for a {@link simplepdl.UtilisationRessource}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createUtilisationRessourceAdapter() {
		if (utilisationRessourceItemProvider == null) {
			utilisationRessourceItemProvider = new UtilisationRessourceItemProvider(this);
		}

		return utilisationRessourceItemProvider;
	}
	...
	public void dispose() {
		...
		if (utilisationRessourceItemProvider != null) utilisationRessourceItemProvider.dispose();
	}
